    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!-- Default box -->
                    <div class="card shadow rounded mx-2" id="printableArea">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                                    ...
                                    <div class="text-center mt-5 mb-3">
                                        ...
                                        ?>
                                            ...
                                            <form method="POST" action="../../database/mainreq/update_timeline.php?id=<?php echo $rowDatas['id_mainreq']; ?>">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <button type="submit" name="btnUpdateTimeline" id="btnUpdateTimeline" class="btn btn-success mb-3"><i class="fas fa-save"></i> &nbsp Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                        <?php
                                        ...
                                        ?>
                                        <button class="btn btn-info mb-2" onclick="printMainReq()" type="submit"> <i class="fa fa-print"></i> Print</button>
                                        <?php
                                        if ($row['level'] == 'Administrator' || $row['level'] == 'Direksi') {
                                        ?>
                                            <button class="btn btn-danger mb-2" onclick="removeReq()" type="submit"> <i class="fas fa-trash"></i> Remove</button>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
