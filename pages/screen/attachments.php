...
$id     = $_GET['id'];
$url    = mysqli_real_escape_string($conn, $id);
...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="wrapper">
            ...
            <?php include("../content/attach_list_content.php"); ?>
...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="wrapper">
            ...
            <?php include('../content/attach_upload_content.php'); ?>
        ...
        <!-- Addons Scripts -->
        <script type="text/javascript">
            <?php include('../scripts/spesific/show_filename.js') ?>
